...
public class MyOffers {
    public static void main(String[] args) {
        ...
        System.out.println(localOffers.size()+" matching local offer: \n"+localOffers);
        System.out.println(offersWithBenefits.size()+" offer has benefits: \n"+offersWithBenefits);
        System.out.println(offersWith100K.size()+" offer more than100k: \n"+offersWith100K);
        System.out.println(sdetOffers.size()+" SDET offer: \n"+sdetOffers);
